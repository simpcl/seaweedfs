...
func NewVolumeServer(adminMux, publicMux *http.ServeMux, ip string,
	...
	adminMux.HandleFunc("/admin/vfile/fetch", vs.guard.WhiteList(vs.fetchVolumeFileHandler))
	adminMux.HandleFunc("/admin/vfile/download", vs.guard.WhiteList(vs.downloadVolumeFileHandler))
	adminMux.HandleFunc("/admin/vfile/delete", vs.guard.WhiteList(vs.deleteVolumeFileHandler))
